...
?>
<?php include "connectdb.php"; ?><!DOCTYPE html>
<html>
<head>
    ...
    <div class="row">
		...
		<div class="col-md-8">
			<div class="card">
				...
				<div class="dropdown">
				<h5>Student Registration </h5> </div></div>
				<div class="card-body" >
					<form class="form-group" action="studreg_process.php" method="POST" enctype="multipart/form-data">
		...
		?>
		<option value="<?php echo $rs["Depaartmentid"]; ?>"><?php echo $rs["Departmentname"]; ?></option>
		<?php
		}
		?>
		</select><br>
						...
						<center> <input type="submit" name="staffreg" value="Register Student" class="btn btn-primary"></center>
					</form>
				</div>
			</div>
		</div>
